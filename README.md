...
Todavía no está armado. Cuando se defina el stack, documentar acá cómo levantarlo.
...
| 2 | Gestión de asistencias (preceptor) | 🔧 En progreso |
| 3 | Seguimiento institucional (directivo) | ⬜ Pendiente |
| 4 | Gestión académica de alumnos | ⬜ Pendiente |
| 5 | Gestión de usuarios y roles | ⬜ Pendiente |
| 6 | Historial y auditoría | ⬜ Pendiente |
| 7 | Reportes y estadísticas | ⬜ Pendiente |
